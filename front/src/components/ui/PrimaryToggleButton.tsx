...
interface PrimaryToggleButtonProps extends Omit<TouchableOpacityProps, 'onPress'> {
  value: boolean;
...
const ToggleContainer = styled.TouchableOpacity<{ $disabled?: boolean; $active: boolean }>`
  width: ${TOGGLE_WIDTH}px;
  height: ${TOGGLE_HEIGHT}px;
  border-radius: ${BORDER_RADIUS}px;
  background-color: ${({ $active }) => $active ? theme.colors.primary : '#E0E0E1'};
