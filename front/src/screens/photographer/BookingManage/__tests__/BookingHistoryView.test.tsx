...
import BookingManageView from '../BookingManageView.tsx';
...
describe('BookingManageView Component', () => {
  ...
  it('renders correctly with bookings', () => {
    const { getByText } = render(<BookingManageView {...defaultProps} />);
  ...
  it('calls onPressBack when back button is pressed', () => {
    ...
    const { getByTestId } = render(<BookingManageView {...props} />);
  ...
  it('calls onPressBookingDetail when detail button is pressed', () => {
    const { getAllByText } = render(<BookingManageView {...defaultProps} />);
  ...
  it('displays error message when isError is true', () => {
    ...
    const { getByText } = render(<BookingManageView {...props} />);
  ...
  it('calls onLoadMore when scrolling to the end', async () => {
    const { getByTestId } = render(<BookingManageView {...defaultProps} />);
  ...
  it('shows action buttons for completed bookings', () => {
    ...
    const { getAllByText } = render(<BookingManageView {...props} />);
  ...
  it('does not show action buttons for non-completed bookings', () => {
    ...
    const { queryByText } = render(<BookingManageView {...props} />);
